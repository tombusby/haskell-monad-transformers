...
-- Replace Identity at the base of the stack with IO:

type Eval6 α =
    ReaderT Env (ExceptT String (WriterT [String] (StateT Integer IO))) α

runEval6 :: Env -> Integer -> Eval6 α
         -> IO ((Either String α, [String]), Integer)
